# modify to act like an L2 learning switch
# vonzhou
...
class Tutorial (object):
  ...
  def act_like_switch (self, packet, packet_in):
    ...
    log.debug('Packet from {} to {} from port {}'.format(packet.src, packet.dst, packet_in.in_port))
    ...
    if dst_port is not None:
      ...
      # instead of resending the packet 
      ...
      log.debug('Donot know which port {} should go to'.format(packet.dst))
      self.resend_packet(packet_in, of.OFPP_ALL)
